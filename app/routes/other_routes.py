...
other_routes.add_url_rule("/", view_func=get_all_others, methods=["GET"])  # Sync Google Classroom announcements
...
other_routes.add_url_rule("<other_id>", view_func=delete_other, methods=["DELETE"])  # Sync Google Classroom announcements